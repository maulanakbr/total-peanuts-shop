...
const CourseForm = ({ userId, type, course, courseId }: CourseFormProps) => {
    ...
    if (type === 'Create') {
      try {
        const newCourse = await createCourse({
          course: { ...values, imageUrl: uploadedImageUrl },
          userId,
          path: '/profile',
        });
    ...
    if (type === 'Update') {
      ...
      try {
        const updatedCourse = await updateCourse({
          userId,
          course: { ...values, imageUrl: uploadedImageUrl, _id: courseId },
